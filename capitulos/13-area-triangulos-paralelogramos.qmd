...
![Untitled](%C3%81rea%20de%20tri%C3%A2ngulos%20e%20paralelogramos/Untitled.png)

### Proposição


 Se  $\vec{u}=\left(a_1,a_2\right)$  e   $\vec{v}=\left(b_1,b_2\right)$  são os lados de  um paralelogramo
$\mathcal{P}$, como na figura acima, então a área de $\mathcal{P}$ é dada por
...
- $\leftarrow$ Click para ver a solução
    ...
    ![material-eu2tdbpc.png](%C3%81rea%20de%20tri%C3%A2ngulos%20e%20paralelogramos/material-eu2tdbpc.png)
